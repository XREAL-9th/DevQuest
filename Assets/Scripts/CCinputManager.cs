...
public class CCinputManager : MonoBehaviour
{
    ...
    [SerializeField] private float sprintMultiplier = 1.8f; // 달릴 때 배속
    ...
    private bool isSprinting; // Shift 눌림 여부
    ...
    private void OnEnable()
    {
        ...
        input.Players.Sprint.performed += _ => isSprinting = true;
        input.Players.Sprint.canceled += _ => isSprinting = false;
    }
